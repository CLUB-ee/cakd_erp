...
#         db_column='menuPic', upload_to='erp/menu/images/', blank=True, null=True)
...
#     # menu_name = Menu.objects.filter(menu_id = menu_id)
#     # menu_name = Menu.objects.filter(menu_id=menu_id).first()
#     class Meta:
#         db_table = 'recipe'
#     def __str__(self):  
